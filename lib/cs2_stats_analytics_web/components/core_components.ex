defmodule Cs2StatsAnalyticsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Cs2StatsAnalyticsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Cs2StatsAnalyticsWeb.Gettext, "errors", msg, opts)
    end
  end
